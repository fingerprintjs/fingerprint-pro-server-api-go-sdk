...
const IntegrationInfo = "fingerprint-pro-server-go-sdk/7.12.1"
...
type FingerprintApiServiceInterface interface {
	...
	*/
	...
	/*
	    ...
	    * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	    * @param visitorId Unique [visitor identifier](https://dev.fingerprint.com/reference/get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals.
	    * @param opts nil or *FingerprintApiGetVisitsOpts - Optional Parameters:
	...
	*/
	...
	/*
	    ...
	    * @param "VisitorId" (string) -  Unique [visitor identifier](https://dev.fingerprint.com/reference/get-function#visitorid) issued by Fingerprint Identification and all active Smart Signals. Filter for events matching this `visitor_id`.
	    ...
	    * @param "Reverse" (bool) -  When `true`, sort events oldest first (ascending timestamp order). Default is newest first (descending timestamp order).
...
func createGetEventDefinition() requestDefinition {
	return requestDefinition{
		...
		StatusCodeResultsFactoryMap: map[int]func() any{
			...
			404: func() any { return &ErrorResponse{} },
			429: func() any { return &ErrorResponse{} },
			504: func() any { return &ErrorResponse{} },
		},
	}
}
...
func createGetVisitsDefinition() requestDefinition {
	return requestDefinition{
		...
		StatusCodeResultsFactoryMap: map[int]func() any{
			...
			404: func() any { return &ErrorPlainResponse{} },
