...
> ```
>
> If your subscription region is not the “Global/US” region, you need to switch the region in the `getVisits.go` and `getEvent.go` source files first.
...
| ---------------- | ------------------------------------------------- | ------------------------------ | ----------------------- |
| _FingerprintApi_ | [**GetEvent**](docs/FingerprintApi.md#getevent)   | **Get** /events/{request_id}   | Get event by requestId  |
| _FingerprintApi_ | [**GetVisits**](docs/FingerprintApi.md#getvisits) | **Get** /visitors/{visitor_id} | Get visits by visitorId |
